...
<h1 class="mb-4">Agregar Nueva Pista</h1>

<form action="<?php echo URLROOT; ?>/admin/agregarPista" method="post">
    ...
    <input type="submit" class="btn btn-primary" value="Agregar Pista">

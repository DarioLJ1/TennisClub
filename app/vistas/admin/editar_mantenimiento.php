...
<form action="<?php echo URLROOT; ?>/admin/editarMantenimiento/<?php echo $datos['id']; ?>" method="post">
    ...
    <input type="submit" class="btn btn-primary" value="Actualizar Mantenimiento">
